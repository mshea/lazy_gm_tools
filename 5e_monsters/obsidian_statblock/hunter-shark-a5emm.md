...
- monster/type/Beast
statblock: inline
aliases: ["hunter-shark-a5e", "Hunter Shark-a5emm"]
---
# Hunter Shark A5Emm
...
"actions":
- "desc": "Melee Weapon Attack: +6 to hit  reach 5 ft.  one target. Hit: 11 (2d6+4) piercing damage. On a hit  the shark can use a bonus action to make a second bite attack."
  "name": "Bite"
source:
